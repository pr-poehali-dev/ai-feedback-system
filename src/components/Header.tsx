    ...
    >
      <nav className="container mx-auto px-6 flex items-center justify-between md:px-[24]">
        <a href="/" className="flex items-center gap-3 group" onClick={scrollToTop}>
          <img src="https://cdn.poehali.dev/projects/6c589f2b-9696-4123-b52d-1a228cfa295f/files/69526235-d431-4212-a63f-255efb5e560a.jpg" alt="Granat Land" className="w-auto h-8 rounded" />
          <span className="text-white font-medium tracking-wide text-sm">Granat Land</span>
        </a>
